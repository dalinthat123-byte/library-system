<div class="topbar d-flex justify-content-between align-items-center">
    <h5 class="mb-0" style="font-weight: 600; color: #333;">Build Bright Library</h5>
    ...
    if(isset($_SESSION['staffname'])){
        ...
        <div class="d-flex align-items-center">
            <span class="me-3 text-muted">Welcome, <strong>' . $_SESSION['staffname'] . '</strong></span>
        ...
        // If someone tries to access the page without logging in
